...
class Db():
    ...
    def bd_config(self):
        self.bd_set_host(os.environ["DB_HOST"] if os.environ.__contains__("DB_HOST") else "db")
        self.bd_set_database(os.environ["DB_NAME"] if os.environ.__contains__("DB_NAME") else "postgres")
        self.bd_set_port(os.environ["DB_PORT"] if os.environ.__contains__("DB_PORT") else "5432")
        self.bd_set_user(os.environ["DB_USER"] if os.environ.__contains__("DB_USER") else "postgres")
        self.bd_set_password(os.environ["DB_PASS"] if os.environ.__contains__("DB_PASS") else "postgres")
        self.bd_set_config()
